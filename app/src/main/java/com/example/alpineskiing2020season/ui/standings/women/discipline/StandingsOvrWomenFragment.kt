package com.example.alpineskiing2020season.ui.standings.women.discipline
...
class StandingsOvrWomenFragment : Fragment(R.layout.standings_recycler_view_fragment)  {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        standingsViewModel.getOvrWomen()
